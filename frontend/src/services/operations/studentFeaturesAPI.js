...
import { setPaymentLoading } from "../../redox/slices/courseSlice";
  ...
  try {
    ...
    const options = {
      ...
      handler: function (response) {
        ...
        verifyPayment({ ...response, courseIds: courses, userDetails }, token, navigate, dispatch);
      },
    };
    ...
    console.log("Error during payment API call", error);
